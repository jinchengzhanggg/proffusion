...
if __name__ == "__main__":
    parser.add_argument(
        "--model_dir", default="/root/autodl-tmp/poly/result/sdf_chd8bar_wave/24-10-27_024944", help="directory in which trained model checkpoints are stored"
    )
    parser.add_argument("--type", default="chd", help="{uncond, inp_below, inp_bars, chd}")
    parser.add_argument("--batch_num", default=600, help="how many batches to store")
    parser.add_argument("--output_dir", default="/root/autodl-tmp/poly/result/sdf_chd8bar_wave", help="where to put the file")
    ...
    parser.add_argument(
        "--chkpt_name",
        default="epoch35-val_loss0.003458.ckpt",
